...
<head>
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      $(".block-btn").mousedown(function(){
        $(event.target).removeClass("shadow");
      });
    
      $(".block-btn").mouseup(function(){
        $(event.target).addClass("shadow");
      });

      $(".hobby-btn").mousedown(function(){
        $(event.target).addClass("click-shadow");
      });

      $(".hobby-btn").mouseup(function(){
        $(event.target).removeClass("click-shadow");
      });
  ...
  <body>
    ...
    <div class="container">
      <div class="row center-text">
        <div class="col-sm-4"><a href="#projects"><span class="block-btn btn-text block-text shadow">Projects</span></a></div>
        <div class="col-sm-4"><a href="#contact"><span class="block-btn btn-text block-text shadow">Contact</span></a></div>
        <div class="col-sm-4"><a href="#about"><span class="block-btn btn-text block-text shadow">About</span></a></div>
      </div>          
    </div>
    ...
    <div id="projects" class="">
      ...
      <div class="col-sm-6 col-sm-offset-3 bottom-pad">
        <div class="row project-descript"><p>A fully custom d3.js visualization using data from the LastFM API. Currently built using Angular. The visualization plots a user's monthly top-artists on a circular graphic. Genres are assigned unique color values. Roll-overs reveal artist name and the month's play count. THE LASTFM API IS CURRENTLY BROKEN, but the visualization still works fairly well.</p>
              ...
              <span class="block-btn block-text shadow">
                Example 1
              </span>  
            </a>
            ...
            <a href="https://github.com/rockthecatzva/lastfm-dataviz-angular" class="gitlogo"><img src="images/github-logo.png"></a>
        </div>
      </div>
      ...
      <div class="col-sm-6 col-sm-offset-3 bottom-pad">
        <div class="row project-descript"><p>A Bootstrap Data Dashboard prototype built for a large television media company to demonstrate the capabilities of developing a more robust data management and reporting tool. The project was full stack, including a SQL database and pathways for users to add new data via uploading text files. The API was developed using the PHP Slim Framework. Front end is React.js (ES6) and c3.js (a d3 library).</p>
            ...
            <a href="https://github.com/rockthecatzva/tvratings-slimtracker" class="gitlogo"><img src="images/github-logo.png"></a>
        </div>
      </div>
      ...
      <div class="col-sm-6 col-sm-offset-3 bottom-pad">
        <div class="row project-descript"><p>A quick turn-around mircrosite for a Colorado-based marketing and graphic design agency. Simple HTML and jQuery. Features complex cell-like animations.</p>
            ...
            <a href="https://github.com/rockthecatzva/hichew-microsite" class="gitlogo"><img src="images/github-logo.png"></a>
        </div>
      </div>
    ...
    <div id="about">
      <div class="row">
        <div class="circlepic col-sm-2 col-sm-offset-5 col-xs-4 col-xs-offset-4">
          <img style="width: 100%;" src="./images/circle-selfie.png" />
        </div>
      </div>
      <div class="row">
        <div class="col-sm-8 col-sm-offset-2 col-xs-12 bottom-pad">
      ...
      <div class="row">
        <div class="col-sm-4 col-sm-offset-2 biobox-sm">
          <a class="hobby-btn" href="https://www.youtube.com/watch?v=WyLPpGdfR7s" target="_blank" >
        ...
        <div class="col-sm-4 biobox-sm">
          <a class="hobby-btn" href="https://www.youtube.com/watch?v=RLGpJlh3Peo" target="_blank">
        ...
        <div class="col-sm-4 biobox-sm">
          <a class="hobby-btn" href="https://youtu.be/TKoJgo5DLRU" target="_blank">
    ...
    <div id="contact" class="pad-section">
      <div class="row bottom-pad">
          <span class="contact-title block-text">Contact</span>
      </div>
      <div class="row">
        <div class="col-sm-4 col-sm-offset-1">
          ...
          <div class="row address-sect">
            ...
            <a href="https://github.com/rockthecatzva"><img src="images/github-logo.png"></a>
